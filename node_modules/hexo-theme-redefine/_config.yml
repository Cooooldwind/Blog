...
info:
  # Site title
  title: CooooldWind_的小站
  # Author name
  author: CooooldWind_
  # Site URL
  url: https://cooooldwind.netlify.app
...
home_banner:
  ...
  # Home banner image
  image: 
    light: /images/background.jpg # /images/wallhaven-wqery6-light.webp # light mode
    dark: /images/background_dark.jpg # /images/wallhaven-wqery6-dark.webp # dark mode
  # Home banner title
  title: CooooldWind_
  # Home banner subtitle
  subtitle:
    text: ['正在加载...'] # subtitle text, array
    hitokoto:  # 一言配置
    ...
    backing_delay: 10000 # Backing delay (ms)
  ...
  social_links:
    ...
    # Social links
    links:
      github: https://github.com/Cooooldwind # your GitHub URL
      #instagram: # your Instagram URL
      zhihu: https://www.zhihu.com/people/Cold_Wind # your ZhiHu URL
      #twitter:  # your twitter URL
      email: 3091868003@qq.com # your email
      # ...... # you can add more
...
navbar:
  ...
  color:
    left: "#509bff" #left side 
    right: "#96C0FA"  #right side
    transparency: 70 #percent (10-99)
  ...
  links:
    ...
    About: 
      ...
      submenus:
    #     Me: /about
        Github: https://github.com/Cooooldwind
        Gitee: https://gitee.com/CooooldWind
        洛谷: https://www.luogu.com.cn/user/747369
        B站: https://space.bilibili.com/399740284
        知乎: https://www.zhihu.com/people/Cold_Wind
    #     Friends: /friends
    # Links: 
...
home:
  ...
  sidebar:
    ...
    announcement: "Ver:1.2.4.240420" # Announcement text
    show_on_mobile: false # Whether to show sidebar navigation on mobile sheet menu
    links:
      # Archives: 
      #   path: /archives 
      #   icon: fa-regular fa-archive # can be empty
      ...
      # ...... # you can add more
  # Article date format
  article_date_format: YYYY/MM/DD HH:MM # auto, relative, YYYY-MM-DD, YYYY-MM-DD HH:mm:ss etc.
...
articles:
  ...
  style:
    ...
    image_border_radius: 8px # image border radius
...
comment:
  ...
  config:
    ...
    waline:
      serverUrl: https://cooooldwind-comment.netlify.app/.netlify/functions/comment # Waline server URL. e.g. https://example.example.com
      lang: zh-CN # Waline language. e.g. zh-CN, en-US. See https://waline.js.org/guide/client/i18n.html
      emoji: [
        "https://unpkg.com/@waline/emojis@1.2.0/bilibili",
        "https://unpkg.com/@waline/emojis@1.2.0/tieba",
        "https://unpkg.com/@waline/emojis@1.2.0/qq",
      ] # Waline emojis, see https://waline.js.org/guide/features/emoji.html
...
footer:
  ...
  start: 2023/10/14 13:57:30
  # Footer message
  customize: 
  # ICP record number. See https://beian.miit.gov.cn/
  icp:
    enable: true # Whether to enable
    number: 萌ICP备20236366号 # ICP record number
    url: https://icp.gov.moe/?keyword=20236366 # ICP record url
# FOOTER <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< end
...
plugins:
  ...
  aplayer:
    ...
    audios:
      - name: 随机歌曲
        artist: 岑鬼鬼的API
        url: https://api.cenguigui.cn/api/netease/?&type=mp3 # audio url
        cover: https://api.cenguigui.cn/api/netease/?&type=song_name?&type=img # audio cover url
#      - name: # audio name
#        artist: # audio artist
#        url: # audio url
